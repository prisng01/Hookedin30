...
/*======================================================
 LOADING SCREEN & INTRO TRANSITION (FIXED)
======================================================*/
...
const loadingAnimation = setInterval(() => {
    ...
    if (load % 20 === 0 && loadingText && messageIndex < loadingMessages.length) {
...
/*======================================================
 PHASE 1 GAME ENGINE & HIDDEN OBJECTS (HOTSPOT SUPPORT)
======================================================*/

let bearDistance = 100;
let bearInterval = null;

// Tent configured as an invisible background hotspot
const hiddenItems = [
...
function showHint() {
    ...
    const objects = scene.querySelectorAll(".collectible, .collectible-hotspot");
    objects.forEach(obj => {
...
function showBirthdayEnding() {
    ...
    // Replace with your GitHub repository link for Mission 3
    const nextMissionUrl = "https://prisng01.github.io/Hookedin30/";
    ...
    ending.innerHTML = `
        <div class="endingWindow">
            ...
            <h1>🔒 Mission 3</h1>
            <p>
                Transmission ready for launch!
            </p>
            <br>
            <button onclick="window.location.href='${nextMissionUrl}'">
